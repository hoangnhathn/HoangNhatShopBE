package com.HNSSpring.HNS.utils;
...
public class MessageKeys {
    ...
    public static final String USER_NOT_ACTIVE = "user.login.not_active";
    public static final String DELETE_USER_SUCCESSFULLY = "user.delete.delete_successfully";
